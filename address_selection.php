        ...
        <div class="row d-flex flex-wrap">
          <div class="col-lg-6">
              ...
              <div class="billing-details">
                ...
                <input type="checkbox" name="saveAddress" id="save" value="yes" checked style="display:none">
                <label for="lname"><b>Please Enter Your Address</b></label><br><br>
                ...
                <label for="city"><b>Town / City /Village *</b></label>
                ...
                <input type="number" id="zip" name="postalCode" value="<?php echo $sellerpincode; ?>" required class="form-control mt-2 mb-4 ps-3">
                  ...
                  <div class="list-group mt-5 mb-3">
                    ...
                    <label class="list-group-item d-flex gap-2 border-0">
                      <input class="form-check-input flex-shrink-0" type="radio" name="listGroupRadios"
                        id="listGroupRadios2" value="online" required checked>
                      <span>
