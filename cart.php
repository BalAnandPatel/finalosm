            ...
            <table id="cartList" class="table">
              ...
              <tbody>
                ...
                foreach ($result as $index => $order) {
                      ...
                      <div class="cart-info d-flex flex-wrap align-items-center mb-4">
                        <div class="col-lg-3">
                          <div class="card-image">
                            <img src="seller/productimages/<?php echo trim($order['pSkuid']);?>/<?php echo trim($order['pSkuid']);?>1.png" alt="cloth" class="img-fluid">
                          </div>
                        </div>
                        <div class="col-lg-9">
                  ...
                  <?php echo $totalprice = str_replace(",","",$order['itemTotal']) + $totalprice; 
                  ?>
