      ...
      <div class="container-fluid">
        <div class="row g-5">
          ...
          <main class="col-md-10">
            ...
            <!-- OPenning POpup -->
            <!-- <img id="myImg" class="d-none" src="https://png.pngtree.com/png-vector/20240726/ourmid/pngtree-grand-opening-text-effect-design-vector-png-image_13069101.png" alt="Snow" style="width:100%;max-width:300px"> -->
                  ...
                  <div class="col">
                    <form id="cart" class="form-group flex-wrap" action="admin/action/shop_cookies.php" method="POST">
                      <div class="product-item ">
                        ...
                        <!-- <h6>Seller: <?php // echo $resultProduct->records[$i]->sellerName; 
                                          ?></h6> -->
